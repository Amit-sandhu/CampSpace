/*
 * BEGINNER GUIDE: src/lib/oauth.js
 * This file handles the Social login/OAuth browser helpers.
 * Syllabus topics visible here: Browser storage / JSON, DOM events / event handling, props / component composition.
...
export function runOAuthScript() {
  'use strict';
  ...
  // BEGINNER: handleGoogleCredential()
  // Main job: perform one focused task for this file.
  // It receives data/props, performs the required work, and returns the result or UI.
  // Keeping this job in one function makes the code easier to follow during the PPT.
  ...
  // BEGINNER: initializeGoogleOAuth()
  // Main job: perform one focused task for this file.
  // It receives data/props, performs the required work, and returns the result or UI.
  // Keeping this job in one function makes the code easier to follow during the PPT.

/*
 * BEGINNER GUIDE: src/lib/auth.js
 * This file handles the Client-side prototype authentication.
 * Syllabus topics visible here: Fetch API / async-await, Browser storage / JSON, DOM events / event handling, props / component composition.
